...
type User struct {
	...
	EmailVerified    bool             `gorm:"not null;default:false" json:"emailVerified" form:"emailVerified"`
	Nickname         string           `gorm:"size:16;" json:"nickname" form:"nickname"`
	Avatar           string           `gorm:"type:text" json:"avatar" form:"avatar"`
	Gender           constants.Gender `gorm:"size:16;" json:"gender" form:"gender"`
	Birthday         *time.Time       `json:"birthday" form:"birthday"`
	BackgroundImage  string           `gorm:"type:text" json:"backgroundImage" form:"backgroundImage"`
	Password         string           `gorm:"size:512" json:"password" form:"password"`
	HomePage         string           `gorm:"size:1024" json:"homePage" form:"homePage"`
	Description      string           `gorm:"type:text" json:"description" form:"description"`
	Score            int              `gorm:"type:int(11);not null;index:idx_user_score" json:"score" form:"score"`
	Status           int              `gorm:"type:int(11);index:idx_user_status;not null;" json:"satus" form:"status"`
	TopicCount       int              `gorm:"type:int(11);not null" json:"topicCount" form:"topicCount"`
	CommentCount     int              `gorm:"type:int(11);not null" json:"commentCount" form:"commentCount"`
	FollowCount      int              `gorm:"type:int(11);not null" json:"followCount" form:"followCount"`
	FansCount        int              `gorm:"type:int(11);not null" json:"fansCount" form:"fansCount"`
	Roles            string           `gorm:"type:text" json:"roles" form:"roles"`
	ForbiddenEndTime int64            `gorm:"not null;default:0" json:"forbiddenEndTime" form:"forbiddenEndTie"`
...
type UserToken struct {
	Model
	Token      string `gorm:"size:32;unique;not null" json:"token" form:"tolen"`
	...
	CreateTime int64  `json:"updateTime" form:"updateTime"`
}
