...
const (
	DefaultTokenExpireDays  	= 7 				// 默认token过期时间
	SummaryLen 					= 256 				// 摘要长度
	UploadMaxM					= 10 				// 上传最大大小
	UploadMaxBytes		int64	= 1024 * 1024 * 1024 * UploadMaxM 	// 上传最大字节
	CookieTokenKey 				= "sayhi_token" 	// cookie中token的key
)
